...
(function($, undefined) {
  ...
  function getjQueryFromElement(elem) {
   ...
   // default options
   options: {
      buttonWidth: 250, // (integer | string | 'auto' | null) Sets the min/max/exact width of the button.
      ...
      noneSelectedText: 'Please select a checkbox', // (string | null) The text to show in the button where nothing is selected.  Set to null to use the native select's placeholder text.
