...
namespace MIMPScheme.Repository
{
    public class AddUserRepo
    {
        ...
        public AddUserRepo(IConfiguration _configuration)
        {
        ...
        public bool AddUserDetails(Add_User aus)
        {
            MySqlConnection connection = new MySqlConnection(_connectionString);
            connection.Open();
            MySqlCommand command = new MySqlCommand("AddUserDetails", connection);
